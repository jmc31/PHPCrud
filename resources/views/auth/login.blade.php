...
@section('content')
    <div class="mt-7 border border-gray-200 rounded-xl shadow-sm dark:bg-neutral-900 dark:border-neutral-700">
                    ...
                    <div class="grid gap-y-4">
                        ...
                        <div>
                            <div class="flex justify-between items-center">
                                ...
                                <a class="inline-flex items-center gap-x-1 text-sm dark:text-white decoration-2 hover:underline focus:outline-none focus:underline font-medium"
